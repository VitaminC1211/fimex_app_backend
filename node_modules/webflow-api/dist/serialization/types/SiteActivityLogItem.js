...
exports.SiteActivityLogItem = core.serialization.object({
    ...
    resourceOperation: core.serialization
        .lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).SiteActivityLogItemResourceOperation; }))
        .optional(),
    user: core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).SiteActivityLogItemUser; })).optional(),
